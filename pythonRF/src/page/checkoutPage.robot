...
*** Variables ***
&{checkout}
...    productBlouse=//*[@id="center_column"]/ul/li[2]/div/div[1]/div/a[1]
...    productColorWhite=//a[@name='White']
...
*** Keywords ***
E adicionar um produto na categoria
    [Arguments]  ${category}
    ...
    BuiltIn.Sleep  3s
    Wait Until Page Contains Element  ${checkout.productColorWhite}
    ...
    BuiltIn.Sleep  3s
    Input Text  ${checkout.addressAddress}   Rua Antonio Perez Hernandez 705
